...
- [ ] **Testing Channels**
  ...
  - [x] Testing a Synchronous Reply
    [code:test](https://github.com/smeade/hellophoenix/blob/phx-013-testing/test/hello_web/channelsj/room_channel_test.exs#L14-L17) |
  ...
  - [x] Testing a Broadcast
    [code:test](https://github.com/smeade/hellophoenix/blob/phx-013-testing/test/hello_web/channelsj/room_channel_test.exs#L19-L22) |
  ...
  - [x] Testing an Asynchronous Push from the Server
    [code:test](https://github.com/smeade/hellophoenix/blob/phx-013-testing/test/hello_web/channelsj/room_channel_test.exs#L24-L27) |
